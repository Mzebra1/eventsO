...
const SignIn = () => {
  ...
  return (
    ...
    <section>
      ...
      "offscreen"} aria-ive="assertive">{errMsg}</p>
      <h1>Register</h1>
      <form onSubmit={handleSubmit}>
        ...
        "offscreen"}>
          ...
          mark'>!</span> <span aria-label='at symbol'>@</span> <span 
          aria-label='hashtag'>#</span> <span aria-label='dollar sign'>$</span> <span aria-label='percent'>%</span>
        </p>
